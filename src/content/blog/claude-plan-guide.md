...
<div class="cols">
<div class="col"><div class="icon">🌱</div><div class="name">無料</div><div class="price">$0</div><div class="for">まず試したい人<br>日に数往復まで</div></div>
<div class="col em"><div class="icon">💼</div><div class="name">Pro</div><div class="price">$20/月</div><div class="for">毎日仕事で使う人<br>ほとんどの人の正解</div></div>
<div class="col"><div class="icon">🏭</div><div class="name">Max</div><div class="price">$100/月〜</div><div class="for">AIに作業を任せる人<br>自動化・開発の本格層</div></div>
</div>
...
| Claude Code（コーディング用） | ✕ | ◯（枠は控えめ） | ◎（本格運用向き） |
| Cowork（PCファイル作業の代行） | ✕ | ◯ | ◯ |
